 ...
 */
const findAdminById = `
SELECT id, role_id,  name, email, password, created_at FROM admins WHERE id=$1
`;
...
SELECT id, role_id, name, password, email, created_at FROM admins WHERE email=$1
`;
/**
 * get admin role
 */
...
VALUES ($1,$2,$3,$4,$5,$6,$7,$8) RETURNING id, name, email, phonenumber, country, address, image_url, role_id, created_at, updated_at`;
